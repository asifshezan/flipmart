            ...
            <div class="card-body">
                <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                    ...
                    <tbody class="text-center">
                        ...
                        {{--  Modal  --}}
                        <div class="modal fade" id="deleteModal{{ $data->coupon_slug }}" data-bs-backdrop="static" data-bs-keyboard="false"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <a type="submit" href="{{ route('coupon.softdelete', $data->coupon_slug) }}" class="btn btn-danger" name="delete_data">Yes,
                                            delete it
                                        </a>
