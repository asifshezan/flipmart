            ...
            <div class="card-body">
                <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                    ...
                    <tbody class="text-center">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1" style="">
                                        ...
                                        <li>
                                            <a class="dropdown-item  btn-link delete-modal" href="#"
                                                data-bs-toggle="modal" data-value="" data-bs-target="#deleteModal{{ $data->pro_cat_slug }}"> <i
                        ...
                        {{--  Modal  --}}
                        <div class="modal fade" id="deleteModal{{ $data->pro_cat_slug }}" data-bs-backdrop="static" data-bs-keyboard="false"
