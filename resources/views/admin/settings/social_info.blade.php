    ...
    <div class="col-12">
        <div class="card border border-primary">
            <div class="card-header bg-transparent border-primary d-flex justify-content-between">
                ...
                <a href="{{ route('basic.index') }}" class="btn btn-sm btn-primary waves-effect waves-light">
            ...
            <div class="card-body">
                ...
                @endif
                <form method="POST" action="{{ route('manage.social.update') }}">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group pb-2 {{$errors->has('sm_facebook') ? ' has-error':''}}">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="#" aria-describedby="basic-addon1"
                                        name="sm_facebook" value="{{ $data->sm_facebook }}">
                            ...
                            <div class="form-group pb-2 {{$errors->has('sm_linkedin') ? ' has-error':''}}">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="email" class="form-control" placeholder="#" aria-label="#"
                                        aria-describedby="basic-addon1" name="sm_linkedin" value="{{ $data->sm_linkedin }}">
                            ...
                            <div class="form-group pb-2 {{$errors->has('sm_youtube') ? ' has-error':''}}">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="#" aria-label="#"
                                        aria-describedby="basic-addon1" name="sm_youtube" value="{{ $data->sm_youtube }}">
                            ...
                            <div class="form-group pb-2 {{$errors->has('sm_instagram') ? ' has-error':''}}">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="#" aria-label="#"
                                        aria-describedby="basic-addon1" name="sm_instagram" value="{{ $data->ssm_instagram }}">
                            ...
                            <div class="form-group pb-2 {{$errors->has('sm_slack') ? ' has-error':''}}">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="#" aria-label="#"
                                        aria-describedby="basic-addon1" name="sm_slack" value="{{ $data->sm_slack }}">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group pb-2 {{$errors->has('sm_twitter') ? ' has-error':''}}">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="#" aria-label="#"
                                        aria-describedby="basic-addon1" name="sm_twitter" value="{{ $data->sm_twitter }}">
                            ...
                            <div class="form-group pb-2 {{$errors->has('sm_dribble') ? ' has-error':''}}">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="#" aria-label="#"
                                        aria-describedby="basic-addon1" name="sm_dribble" value="{{ $data->sm_dribble }}">
                            ...
                            <div class="form-group pb-2 {{$errors->has('sm_google') ? ' has-error':''}}">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="#" aria-label="#"
                                        aria-describedby="basic-addon1" name="sm_google" value="{{ $data->sm_google }}">
                            ...
                            <div class="form-group pb-2 {{$errors->has('sm_raddit') ? ' has-error':''}}">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="#" aria-label="#"
                                        aria-describedby="basic-addon1" name="sm_raddit" value="{{ $data->sm_raddit }}">
                            ...
                            <div class="form-group pb-2 {{$errors->has('sm_behance') ? ' has-error':''}}">
                                ...
                                <div class="input-group mb-3">
                                    <span class="input-group-text" id="basic-addon1"><i
                                            class="fab fa-reddit"" aria-hidden=" true"></i></span>
                                    <input type="text" class="form-control" placeholder="#" aria-label="#"
                                        aria-describedby="basic-addon1" name="sm_behance" value="{{ $data->sm_behance }}">
