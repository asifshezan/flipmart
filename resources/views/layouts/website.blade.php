...
<title>Flipmart premium Template</title>
...
<link rel="stylesheet" href="{{asset('contents/website')}}/css/blue.css">
<link rel="stylesheet" href="{{asset('contents/website')}}/css/owl.carousel.css">
<link rel="stylesheet" href="{{asset('contents/website')}}/css/owl.transitions.css">
    ...
    <div class="container">
      <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-3 logo-holder">
          <!-- ============================================================= LOGO ============================================================= -->
          <div class="logo"> <a href="home.html"> <img src="{{asset('contents/website')}}/images/logo.png" alt="logo"> </a> </div>
          <!-- /.logo -->
          <!-- ============================================================= LOGO : END ============================================================= --> </div>
        <!-- /.logo-holder -->
          ...
          <div class="dropdown dropdown-cart"> <a href="#" class="dropdown-toggle lnk-cart" data-toggle="dropdown">
            <div class="items-cart-inner">
              ...
              <div class="total-price-basket"> <span class="lbl">cart -</span> <span class="total-price">
                <span class="sign">$</span><span class="value">{{ Cart::getSubTotal() }}</span> </span> </div>
            </div>
            </a>
            <ul class="dropdown-menu">
              <li>
                <div class="cart-item product-summary">
                  ...
                  <div class="row">
                    <div class="col-xs-4">
                      <div class="image"> <a href="detail.html"><img src="{{asset('uploads/product/'.$cart_data->attributes->product_image)}}" alt=""></a> </div>
                    </div>
                    <div class="col-xs-7">
                      <h3 class="name"><a href="index8a95.html?page-detail">{{ $cart_data->name}}</a></h3>
                      <div class="price">{{ $cart_data->price }}</div>
                    </div>
                    <div class="col-xs-1 action"> <a href="{{ route('cart.destroy',$cart_data->id)}}"><i class="fa fa-trash"></i></a> </div>
                  </div>
                  @endforeach
                </div>
                <!-- /.cart-item -->
                ...
                <div class="clearfix cart-total">
                  <div class="pull-right"> <span class="text">Sub Total :</span><span class='price'>${{ Cart::getSubTotal() }}</span> </div>
                  <div class="clearfix"></div>
                    ...
                    <li>
                      <div class="yamm-content ">
                        <div class="row">
                          ...
                          <div class="col-xs-12 col-sm-6 col-md-4 col-menu banner-image"> <img class="img-responsive" src="{{asset('contents/website')}}/images/banners/top-menu-banner.jpg" alt=""> </div>
                          <!-- /.yamm-content -->
                        </div>
                      </div>
                    </li>
                    ...
                    <li>
                      <div class="yamm-content">
                        <div class="row">
                          ...
                          <div class="col-xs-12 col-sm-12 col-md-4 col-menu custom-banner"> <a href="#"><img alt="" src="{{asset('contents/website')}}/images/banners/banner-side.png"></a> </div>
                        </div>
                        <!-- /.row -->
                      </div>
                      <!-- /.yamm-content --> </li>
    ...
    <div class="container">
      <div class="row">
        <div class="col-xs-12 col-sm-6 col-md-3">
          ...
          <!-- /.module-heading -->
          @php
              $contacts = App\Models\ContactInfo::where('cont_status',1)->where('cont_id',1)->firstOrFail();
          @endphp
          ...
          <div class="module-body">
            <ul class="toggle-footer" style="">
              ...
              <li class="media">
                ...
                <div class="media-body"> <span><a href="#">{{ $contacts -> cont_email1 }}</a></span> </div>
              </li>
            </ul>
          </div>
          <!-- /.module-body -->
    ...
    <div class="container">
      ...
      <div class="col-xs-12 col-sm-6 no-padding">
        <div class="clearfix payment-methods">
          <ul>
            <li><img src="{{asset('contents/website')}}/images/payments/1.png" alt=""></li>
            <li><img src="{{asset('contents/website')}}/images/payments/2.png" alt=""></li>
            <li><img src="{{asset('contents/website')}}/images/payments/3.png" alt=""></li>
            <li><img src="{{asset('contents/website')}}/images/payments/4.png" alt=""></li>
            <li><img src="{{asset('contents/website')}}/images/payments/5.png" alt=""></li>
          </ul>
        </div>
        <!-- /.payment-methods -->
      </div>
...
<script src="{{asset('contents/website')}}/js/bootstrap-hover-dropdown.min.js"></script>
<script src="{{asset('contents/website')}}/js/owl.carousel.min.js"></script>
<script src="{{asset('contents/website')}}/js/echo.min.js"></script>
<script src="{{asset('contents/website')}}/js/jquery.easing-1.3.min.js"></script>
<script src="{{asset('contents/website')}}/js/bootstrap-slider.min.js"></script>
<script src="{{asset('contents/website')}}/js/jquery.rateit.min.js"></script>
